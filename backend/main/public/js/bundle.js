...
module.exports = {
  ...
  "_spec": "axios@^0.21.4",
  "_where": "D:\\works101\\soft-dev\\backend\\main",
  "author": {
    "name": "Matt Zabriskie"
  },
  "browser": {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'password' ? 'http://127.0.0.1:3000/user/updateMyPassword' : 'http://127.0.0.1:3000/user/updateMe';
            _context.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
              url: url,
...
var hi = Qs.parse(location.search, {
  ignoreQueryPrefix: true
});
console.log(hi);
...
document.getElementById('leave-btn').addEventListener('click', function () {
  var leaveRoom = confirm('Are you sure you want to leave the chatroom?');
